                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="../action/register.php" method="POST">
                                <div class="form-group">
                                    <input type="name" class="form-control form-control-user" placeholder="Nama" name="name">
                                </div>
                                ...
                                <button class="btn btn-primary btn-user btn-block" type="submit" value="Register" name="register">
                                    Daftarkan Akun
                                </button>
                                <hr>
                            </form>
